...
My research aims to advance the scientific understanding of **artificial intelligence** by combining experiments and theory, often drawing on methods from **statistical physics** and **complex systems**. A primary focus of my work is to characterize the latent **structure of data**, such as language and images, and to understand how neural networks build **internal representations** of this structure. I'm also interested in leveraging these insights to accelerate **scientific discovery** with AI.
